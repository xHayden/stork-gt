...
var dues = Number(process.env.DEFAULT_DUES);
var createUser = function (route, name, email) { return __awaiter(void 0, void 0, void 0, function () {
    var dbClient, db, collection, filter, user, update, options, doc, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                e_1 = _a.sent();
                throw new errors_1.FailedToCreateError(route, types_1.DBUser);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, createUser(route, data.name, data.email)];
                case 3:
                    res = _a.sent();
                    return [3 /*break*/, 5];
                case 4:
